...
console.log ("I’m starting to study in a " + program + " here in Canada, so my weekly past time activities were understand everything about this " + program + ", such as where to get to the " + program + ", which bus I should get, and also the location and time for each " + classes + ". In this " + program + ", I have " + 8 + " different " + classes + ". The number of the " + classes + " are big, so I need to pay attention in everything so I don’t get lost in the " + program + ".");

/* need to write 

multiple console logs */

console.log ("______________________________REVIEW ONE______________________________");
